...
#[command(group(
    ArgGroup::new("startup_tab_append_command")
        .args(["add_startup_tab", "add_profile_startup_tab"])
))]
#[command(group(
    ArgGroup::new("startup_tab_remove_command")
        .args(["remove_startup_tab", "remove_profile_startup_tab"])
))]
#[command(group(
    ArgGroup::new("startup_tab_move_command")
        .args(["move_startup_tab"])
))]
#[command(group(
...
struct Cli {
    ...
    #[arg(
        ...
        help = "Append one root startup tab to terminal.json without opening a terminal window"
    )]
    add_startup_tab: bool,
    ...
    #[arg(
        ...
        help = "Append one nested startup tab to a named profile in terminal.json without opening a terminal window"
    )]
    add_profile_startup_tab: Option<String>,

    #[arg(
        long = "startup-tab-profile",
        value_name = "NAME",
        requires = "startup_tab_append_command",
        conflicts_with_all = [
            "startup_tab_working_directory",
            "startup_tab_command",
            "startup_tab_shell",
            "startup_tab_shell_args",
            "startup_tab_env"
        ],
        help = "Append a startup tab from a named profile"
    )]
    startup_tab_profile: Option<String>,

    #[arg(
        long = "startup-tab-working-directory",
        value_name = "DIRECTORY",
        value_hint = ValueHint::DirPath,
        requires = "startup_tab_append_command",
        conflicts_with = "startup_tab_profile",
        help = "Set working_directory for the appended startup tab"
    )]
    startup_tab_working_directory: Option<PathBuf>,

    #[arg(
        long = "startup-tab-command",
        value_name = "COMMAND",
        requires = "startup_tab_append_command",
        conflicts_with_all = ["startup_tab_profile", "startup_tab_shell", "startup_tab_shell_args"],
        help = "Set command for the appended startup tab"
    )]
    startup_tab_command: Option<String>,

    #[arg(
        long = "startup-tab-title",
        value_name = "TITLE",
        requires = "startup_tab_append_command",
        help = "Set title for the appended startup tab"
    )]
    startup_tab_title: Option<String>,

    #[arg(
        long = "startup-tab-shell",
        value_name = "PROGRAM",
        requires = "startup_tab_append_command",
        conflicts_with_all = ["startup_tab_profile", "startup_tab_command"],
        help = "Set shell program for the appended startup tab"
    )]
    startup_tab_shell: Option<String>,

    #[arg(
        long = "startup-tab-shell-arg",
        value_name = "ARG",
        requires = "startup_tab_shell",
        allow_hyphen_values = true,
        help = "Append one shell argument for --startup-tab-shell"
    )]
    startup_tab_shell_args: Vec<String>,

    #[arg(
        long = "startup-tab-env",
        value_name = "KEY=VALUE",
        requires = "startup_tab_command",
        conflicts_with = "startup_tab_profile",
        help = "Set one environment variable for a command-backed appended startup tab; repeat to set multiple"
    )]
    startup_tab_env: Vec<String>,

    #[arg(
        long = "startup-tab-split",
        value_name = "DIRECTION",
        value_enum,
        requires = "startup_tab_append_command",
        help = "Set split direction for the appended startup tab"
    )]
    startup_tab_split: Option<TerminalStartupSplitDirection>,
    ...
    #[arg(
        ...
        conflicts_with_all = [
            "add_profile_startup_tab",
            "add_profile_startup_tab_format",
            "remove_startup_tab",
            "remove_startup_tab_format",
            "remove_profile_startup_tab",
            "profile_startup_tab",
            "remove_profile_startup_tab_format",
            "move_startup_tab",
            "to_startup_tab",
            "move_startup_tab_format"
        ],
    ...
    #[arg(
        long = "add-profile-startup-tab-format",
        value_enum,
        requires = "add_profile_startup_tab",
        conflicts_with_all = [
            "add_startup_tab",
            "add_startup_tab_format",
            "remove_startup_tab",
            "remove_startup_tab_format",
            "remove_profile_startup_tab",
            "profile_startup_tab",
        ...
        help = "Set the output format for --add-profile-startup-tab"
    )]
    add_profile_startup_tab_format: Option<TerminalStartupProfileTabAppendOutputFormat>,
    ...
    #[arg(
        long = "remove-profile-startup-tab",
        value_name = "NAME",
        ...
        help = "Remove one nested startup tab from a named profile in terminal.json without opening a terminal window"
    )]
    remove_profile_startup_tab: Option<String>,

    #[arg(
        long = "profile-startup-tab",
        value_name = "TAB",
        requires = "remove_profile_startup_tab",
        help = "Set the 1-based profile tabs[] number for --remove-profile-startup-tab"
    )]
    profile_startup_tab: Option<usize>,

    #[arg(
        long = "remove-profile-startup-tab-format",
        value_enum,
        requires = "remove_profile_startup_tab",
        conflicts_with_all = [
            "add_startup_tab",
        ...
        help = "Set the output format for --remove-profile-startup-tab"
    )]
    remove_profile_startup_tab_format: Option<TerminalStartupProfileTabRemovalOutputFormat>,

    #[arg(
        long = "move-startup-tab",
        value_name = "FROM",
        ...
        help = "Move one root startup tab in terminal.json by 1-based root tabs[] number without opening a terminal window"
    )]
    move_startup_tab: Option<usize>,

    #[arg(
        long = "to-startup-tab",
        value_name = "TO",
        requires = "move_startup_tab",
        help = "Set the destination 1-based root tabs[] number for --move-startup-tab"
    )]
    to_startup_tab: Option<usize>,

    #[arg(
        long = "move-startup-tab-format",
        value_enum,
        requires = "move_startup_tab",
        conflicts_with_all = [
            "add_startup_tab",
        ...
        help = "Set the output format for --move-startup-tab"
    )]
    move_startup_tab_format: Option<TerminalStartupTabMoveOutputFormat>,
...
enum TerminalCliCommand {
    ...
    AddProfileStartupTab {
        path_options: TerminalPathOptions,
        profile: String,
        tab: TerminalStartupTabConfig,
        format: TerminalStartupProfileTabAppendOutputFormat,
    },
    RemoveStartupTab {
        path_options: TerminalPathOptions,
        tab_number: usize,
    ...
    RemoveProfileStartupTab {
        path_options: TerminalPathOptions,
        profile: String,
        tab_number: usize,
        format: TerminalStartupProfileTabRemovalOutputFormat,
    },
    MoveStartupTab {
        path_options: TerminalPathOptions,
        from_tab_number: usize,
        to_tab_number: usize,
        format: TerminalStartupTabMoveOutputFormat,
    },
    UpdateProfileEnv {
        path_options: TerminalPathOptions,
        profile: String,
...
#[derive(Clone, Debug, PartialEq, Eq)]
struct TerminalStartupTabAppend {
    path: PathBuf,
    tab_number: usize,
...
#[derive(Clone, Debug, PartialEq, Eq)]
struct TerminalStartupProfileTabAppend {
    path: PathBuf,
    profile: String,
    tab_number: usize,
    previous_tab_count: usize,
...
#[derive(Clone, Debug, PartialEq, Eq)]
struct TerminalStartupProfileTabRemoval {
    path: PathBuf,
    profile: String,
    tab_number: usize,
    previous_tab_count: usize,
...
#[derive(Clone, Copy, Debug, Default, PartialEq, Eq, ValueEnum)]
enum TerminalStartupTabAppendOutputFormat {
    #[default]
    Text,
    Json,
}
...
#[derive(Clone, Copy, Debug, Default, PartialEq, Eq, ValueEnum)]
enum TerminalStartupProfileTabAppendOutputFormat {
    #[default]
    Text,
    Json,
}
...
#[derive(Clone, Copy, Debug, Default, PartialEq, Eq, ValueEnum)]
enum TerminalStartupProfileTabRemovalOutputFormat {
    #[default]
    Text,
    Json,
}
...
#[derive(Clone, Copy, Debug, Default, PartialEq, Eq, ValueEnum)]
enum TerminalStartupTabMoveOutputFormat {
    #[default]
    Text,
    Json,
}
...
impl TerminalCliCommand {
    fn from_cli_and_config_file(cli: Cli) -> Result<Self> {
        ...
        let startup_config = if cli.print_paths
            ...
            || cli.add_startup_tab
            || cli.add_profile_startup_tab.is_some()
            || cli.remove_startup_tab.is_some()
            || cli.remove_profile_startup_tab.is_some()
            || cli.move_startup_tab.is_some()
    ...
    fn from_cli_parts(
        ...
        if cli.add_startup_tab {
            let tab = startup_tab_config_from_cli(&cli, "appended root startup tab")?;
            return Ok(Self::AddStartupTab {
                path_options,
                tab,
        ...
        if let Some(profile) = cli.add_profile_startup_tab.as_deref() {
            let profile = normalize_startup_profile_name(profile)?;
            let tab = startup_tab_config_from_cli(&cli, "appended startup profile tab")?;
            return Ok(Self::AddProfileStartupTab {
                path_options,
                profile,
                tab,
                format: cli.add_profile_startup_tab_format.unwrap_or_default(),
            });
        }
        ...
        if let Some(profile) = cli.remove_profile_startup_tab.as_deref() {
            let profile = normalize_startup_profile_name(profile)?;
            let tab_number = cli
                .profile_startup_tab
                .expect("--profile-startup-tab is required by --remove-profile-startup-tab");
            validate_profile_startup_tab_number(tab_number, "--profile-startup-tab")?;
            return Ok(Self::RemoveProfileStartupTab {
                path_options,
                profile,
                tab_number,
                format: cli.remove_profile_startup_tab_format.unwrap_or_default(),
            });
        }

        if let Some(from_tab_number) = cli.move_startup_tab {
            let to_tab_number = cli
                .to_startup_tab
                .expect("--to-startup-tab is required by --move-startup-tab");
            validate_root_startup_tab_number(from_tab_number, "--move-startup-tab")?;
            validate_root_startup_tab_number(to_tab_number, "--to-startup-tab")?;
            return Ok(Self::MoveStartupTab {
                path_options,
                from_tab_number,
                to_tab_number,
                format: cli.move_startup_tab_format.unwrap_or_default(),
            });
        }
    ...
    fn path_options(&self) -> &TerminalPathOptions {
        match self {
            ...
            Self::AddProfileStartupTab { path_options, .. } => path_options,
            Self::RemoveStartupTab { path_options, .. } => path_options,
            Self::RemoveProfileStartupTab { path_options, .. } => path_options,
            Self::MoveStartupTab { path_options, .. } => path_options,
...
fn main() {
    ...
    match command {
        ...
        TerminalCliCommand::AddStartupTab { tab, format, .. } => {
            if let Err(error) = print_startup_tab_append(&tab, format) {
                eprintln!("failed to append root startup tab: {error:#}");
                process::exit(2);
            }
        }
        TerminalCliCommand::AddProfileStartupTab {
            profile,
            tab,
            format,
            ..
        } => {
            if let Err(error) = print_startup_profile_tab_append(&profile, &tab, format) {
                eprintln!("failed to append startup profile tab: {error:#}");
                process::exit(2);
            }
        }
        ...
        TerminalCliCommand::RemoveProfileStartupTab {
            profile,
            tab_number,
            format,
            ..
        } => {
            if let Err(error) = print_startup_profile_tab_removal(&profile, tab_number, format) {
                eprintln!("failed to remove startup profile tab: {error:#}");
                process::exit(2);
            }
        }
        TerminalCliCommand::MoveStartupTab {
            from_tab_number,
            to_tab_number,
            format,
            ..
        } => {
            if let Err(error) = print_startup_tab_move(from_tab_number, to_tab_number, format) {
                eprintln!("failed to move root startup tab: {error:#}");
                process::exit(2);
            }
        }
...
fn print_startup_tab_append(
    tab: &TerminalStartupTabConfig,
    format: TerminalStartupTabAppendOutputFormat,
) -> Result<()> {
    let append = append_root_startup_tab(&active_terminal_startup_config_file(), tab)?;
    match format {
        TerminalStartupTabAppendOutputFormat::Text => {
            print!("{}", format_startup_tab_append(&append))
        }
        TerminalStartupTabAppendOutputFormat::Json => {
            print!("{}", format_startup_tab_append_json(&append)?)
        }
    }
    Ok(())
}

fn print_startup_profile_tab_append(
    profile: &str,
    tab: &TerminalStartupTabConfig,
    format: TerminalStartupProfileTabAppendOutputFormat,
) -> Result<()> {
    let append = append_startup_profile_tab(&active_terminal_startup_config_file(), profile, tab)?;
    match format {
        TerminalStartupProfileTabAppendOutputFormat::Text => {
            print!("{}", format_startup_profile_tab_append(&append))
        }
        TerminalStartupProfileTabAppendOutputFormat::Json => {
            print!("{}", format_startup_profile_tab_append_json(&append)?)
        }
    }
    Ok(())
}
...
fn print_startup_profile_tab_removal(
    profile: &str,
    tab_number: usize,
    format: TerminalStartupProfileTabRemovalOutputFormat,
) -> Result<()> {
    let removal =
        remove_startup_profile_tab(&active_terminal_startup_config_file(), profile, tab_number)?;
    match format {
        TerminalStartupProfileTabRemovalOutputFormat::Text => {
            print!("{}", format_startup_profile_tab_removal(&removal))
        }
        TerminalStartupProfileTabRemovalOutputFormat::Json => {
            print!("{}", format_startup_profile_tab_removal_json(&removal)?)
        }
    }
    Ok(())
}

fn print_startup_tab_move(
    from_tab_number: usize,
    to_tab_number: usize,
    format: TerminalStartupTabMoveOutputFormat,
) -> Result<()> {
    let move_result = move_root_startup_tab(
        &active_terminal_startup_config_file(),
        from_tab_number,
        to_tab_number,
    )?;
    match format {
        TerminalStartupTabMoveOutputFormat::Text => {
            print!("{}", format_startup_tab_move(&move_result))
        }
        TerminalStartupTabMoveOutputFormat::Json => {
            print!("{}", format_startup_tab_move_json(&move_result)?)
        }
    }
    Ok(())
}
...
fn startup_tab_config_from_cli(cli: &Cli, label: &str) -> Result<TerminalStartupTabConfig> {
    let env = cli
        .startup_tab_env
        .iter()
        .map(|assignment| parse_startup_tab_env_assignment(assignment))
        .collect::<Result<Vec<_>>>()?
        .into_iter()
        .collect::<HashMap<_, _>>();
    let shell = terminal_shell_config_value(
        cli.startup_tab_shell.as_deref(),
        &cli.startup_tab_shell_args,
        "--startup-tab-shell",
    )?;
    let tab = TerminalStartupTabConfig {
        profile: cli
            .startup_tab_profile
            .as_deref()
            .map(normalize_startup_profile_name)
            .transpose()?,
        working_directory: cli.startup_tab_working_directory.clone(),
        command: terminal_command_config_value(
            cli.startup_tab_command.as_deref(),
            "--startup-tab-command",
        )?,
        title: normalize_terminal_title(cli.startup_tab_title.as_deref()),
        shell,
        env,
        split: cli.startup_tab_split,
    };

    validate_startup_tab_config_shape(&tab, label)?;
    Ok(tab)
}

fn validate_startup_tab_config_shape(tab: &TerminalStartupTabConfig, label: &str) -> Result<()> {
    if tab.profile.is_some() {
        TerminalStartupConfig::validate_profile_tab_fields(tab, label)?;
    }
    if tab.command.is_none() && !tab.env.is_empty() {
        bail!("environment variables require a command for {label}");
    }
...
fn validate_profile_startup_tab_number(tab_number: usize, flag: &'static str) -> Result<()> {
    if tab_number == 0 {
        bail!("{flag} uses 1-based profile tabs[] numbering and must be at least 1");
    }
    Ok(())
}
...
fn parse_startup_tab_env_assignment(assignment: &str) -> Result<(String, String)> {
    let (key, value) = assignment
        .split_once('=')
        .with_context(|| "--startup-tab-env requires KEY=VALUE")?;
    Ok((normalize_startup_tab_env_key(key)?, value.into()))
}
...
fn normalize_startup_tab_env_key(key: &str) -> Result<String> {
    let key = key.trim();
    if key.is_empty() {
        bail!("startup tab environment variable key is empty");
    }
    if key.contains('=') {
        bail!("startup tab environment variable key must not contain '='");
    }
    Ok(key.into())
}

fn terminal_command_config_value(
    value: Option<&str>,
    flag: &'static str,
...
fn terminal_shell_config_value(
    program: Option<&str>,
    args: &[String],
    flag: &'static str,
) -> Result<Option<TerminalStartupShellConfig>> {
    let Some(program) = program else {
        return Ok(None);
    };
    let program = normalize_terminal_shell_program(program)
...
fn append_root_startup_tab(
    path: &Path,
    tab: &TerminalStartupTabConfig,
) -> Result<TerminalStartupTabAppend> {
    validate_startup_tab_config_shape(tab, "appended root startup tab")?;
    let mut text = match std_fs::read_to_string(path) {
        Ok(text) => text,
        Err(error) if error.kind() == std::io::ErrorKind::NotFound => {
            initial_terminal_startup_config_content().into()
    ...
    let mut updated_config = startup_config.clone();
    updated_config.tabs.push(tab.clone());
    updated_config.validate().with_context(|| {
        format!(
            "refusing to append root startup tab because it would make {} invalid",
            path.display()
        )
    })?;

    let new_value = startup_tab_config_to_json_value(tab);
    let key_path = vec!["tabs".to_string(), format!("#{previous_tab_count}")];
    let (range, replacement) = settings_json::replace_value_in_json_text(
        &text,
        &key_path,
        settings_json::infer_json_indent_size(&text),
    ...
    if parsed_updated_config != updated_config {
        bail!(
            "refusing to write terminal startup config {} because startup tab append produced unexpected content",
            path.display()
        );
    }
    ...
    Ok(TerminalStartupTabAppend {
        path: path.to_path_buf(),
        tab_number: previous_tab_count + 1,
        previous_tab_count,
...
fn append_startup_profile_tab(
    path: &Path,
    profile: &str,
    tab: &TerminalStartupTabConfig,
) -> Result<TerminalStartupProfileTabAppend> {
    validate_startup_tab_config_shape(tab, "appended startup profile tab")?;
    let profile = normalize_startup_profile_name(profile)?;
    let mut text = std_fs::read_to_string(path)
        .with_context(|| format!("failed to read terminal startup config {}", path.display()))?;
    let startup_config = settings::parse_json_with_comments::<TerminalStartupConfig>(&text)
    ...
    let previous_tab_count = startup_profile.tabs.len();
    ...
    updated_config.validate().with_context(|| {
        format!(
            "refusing to append startup profile tab for {profile:?} because it would make {} invalid",
            path.display()
        )
    })?;
    ...
    if parsed_updated_config != updated_config {
        bail!(
            "refusing to write terminal startup config {} because startup profile tab append produced unexpected content",
            path.display()
        );
    }
    ...
    Ok(TerminalStartupProfileTabAppend {
        path: path.to_path_buf(),
        profile,
        tab_number: previous_tab_count + 1,
        previous_tab_count,
...
fn remove_startup_profile_tab(
    path: &Path,
    profile: &str,
    tab_number: usize,
) -> Result<TerminalStartupProfileTabRemoval> {
    validate_profile_startup_tab_number(tab_number, "--profile-startup-tab")?;
    let profile = normalize_startup_profile_name(profile)?;
    let mut text = match std_fs::read_to_string(path) {
        Ok(text) => text,
        Err(error) if error.kind() == std::io::ErrorKind::NotFound => {
            return Ok(TerminalStartupProfileTabRemoval {
                path: path.to_path_buf(),
                profile,
                tab_number,
                previous_tab_count: 0,
    ...
    let startup_config = settings::parse_json_with_comments::<TerminalStartupConfig>(&text)
        .with_context(|| format!("failed to parse terminal startup config {}", path.display()))?;
    let Some(startup_profile) = startup_config.profiles.get(&profile) else {
        return Ok(TerminalStartupProfileTabRemoval {
            path: path.to_path_buf(),
            profile,
            tab_number,
    ...
    let previous_tab_count = startup_profile.tabs.len();
    let Some(remove_index) = tab_number.checked_sub(1) else {
        unreachable!("profile startup tab number is already validated")
    };
    let Some(removed_tab) = startup_profile.tabs.get(remove_index).cloned() else {
        return Ok(TerminalStartupProfileTabRemoval {
            path: path.to_path_buf(),
            profile,
            tab_number,
    ...
    updated_config.validate().with_context(|| {
        format!(
            "refusing to remove startup profile tab {tab_number} for {profile:?} because it would make {} invalid",
            path.display()
        )
    })?;
    ...
    if parsed_updated_config != updated_config {
        bail!(
            "refusing to write terminal startup config {} because startup profile tab removal produced unexpected content",
            path.display()
        );
    }
    ...
    Ok(TerminalStartupProfileTabRemoval {
        path: path.to_path_buf(),
        profile,
        tab_number,
        previous_tab_count,
...
fn move_root_startup_tab(
    path: &Path,
    from_tab_number: usize,
    to_tab_number: usize,
) -> Result<TerminalStartupTabMove> {
    validate_root_startup_tab_number(from_tab_number, "--move-startup-tab")?;
    validate_root_startup_tab_number(to_tab_number, "--to-startup-tab")?;
    let mut text = match std_fs::read_to_string(path) {
        Ok(text) => text,
        Err(error) if error.kind() == std::io::ErrorKind::NotFound => {
            return Ok(TerminalStartupTabMove {
                path: path.to_path_buf(),
                from_tab_number,
                to_tab_number,
                previous_tab_count: 0,
    ...
    let startup_config = settings::parse_json_with_comments::<TerminalStartupConfig>(&text)
        .with_context(|| format!("failed to parse terminal startup config {}", path.display()))?;
    let previous_tab_count = startup_config.tabs.len();
    let Some(from_index) = from_tab_number.checked_sub(1) else {
        unreachable!("root startup tab number is already validated")
    };
    let Some(to_index) = to_tab_number.checked_sub(1) else {
        unreachable!("root startup tab number is already validated")
    };
    let Some(moved_tab) = startup_config.tabs.get(from_index).cloned() else {
        return Ok(TerminalStartupTabMove {
            path: path.to_path_buf(),
            from_tab_number,
            to_tab_number,
    ...
    if to_index >= previous_tab_count || from_index == to_index {
        return Ok(TerminalStartupTabMove {
            path: path.to_path_buf(),
            from_tab_number,
            to_tab_number,
            previous_tab_count,
            tab_count: previous_tab_count,
            tab: Some(startup_profile_tab_description(&moved_tab)),
            changed: false,
        });
    }

    let mut updated_config = startup_config.clone();
    let moved_tab = updated_config.tabs.remove(from_index);
    updated_config.tabs.insert(to_index, moved_tab.clone());
    updated_config.validate().with_context(|| {
        format!(
            "refusing to move root startup tab {from_tab_number} to {to_tab_number} because it would make {} invalid",
            path.display()
        )
    })?;
    ...
    if parsed_updated_config != updated_config {
        bail!(
            "refusing to write terminal startup config {} because startup tab move produced unexpected content",
            path.display()
        );
    }
...
fn format_startup_profile_tab_description(
    ...
    format_startup_profile_tab_description_body(output, "  ", tab);
}

fn format_startup_profile_tab_description_body(
    output: &mut String,
    prefix: &str,
    tab: &TerminalStartupProfileTabDescription,
) {
    ...
    .expect("writing to string should not fail");
    format_env_key_list(output, prefix, &tab.env_keys);
    writeln!(
        output,
        "{prefix}split: {}",
        tab.split
...
fn format_startup_tab_append(append: &TerminalStartupTabAppend) -> String {
    let mut output = String::new();
    writeln!(
        &mut output,
        "startup_config_file: {}",
    ...
    .expect("writing to string should not fail");
    writeln!(&mut output, "status: ok").expect("writing to string should not fail");
    writeln!(&mut output, "tab: {}", append.tab_number).expect("writing to string should not fail");
    writeln!(&mut output, "previous_tabs: {}", append.previous_tab_count)
        .expect("writing to string should not fail");
    writeln!(&mut output, "tabs: {}", append.tab_count).expect("writing to string should not fail");
    writeln!(&mut output, "changed: {}", append.changed)
        .expect("writing to string should not fail");
    writeln!(&mut output, "tab_config:").expect("writing to string should not fail");
    format_startup_profile_tab_description_body(&mut output, "  ", &append.tab);
    output
}

fn format_startup_tab_append_json(append: &TerminalStartupTabAppend) -> Result<String> {
    let value = serde_json::json!({
        "startup_config_file": append.path.display().to_string(),
        "status": "ok",
        "tab": append.tab_number,
        "previous_tab_count": append.previous_tab_count,
        "tab_count": append.tab_count,
        "changed": append.changed,
        "tab_config": startup_profile_tab_description_json(append.tab_number, &append.tab),
    });
    let mut output = serde_json::to_string_pretty(&value)
...
fn format_startup_profile_tab_append(append: &TerminalStartupProfileTabAppend) -> String {
    let mut output = String::new();
    writeln!(
        &mut output,
        "startup_config_file: {}",
    ...
    .expect("writing to string should not fail");
    writeln!(&mut output, "status: ok").expect("writing to string should not fail");
    writeln!(&mut output, "profile: {}", append.profile)
        .expect("writing to string should not fail");
    writeln!(&mut output, "tab: {}", append.tab_number).expect("writing to string should not fail");
    writeln!(&mut output, "previous_tabs: {}", append.previous_tab_count)
        .expect("writing to string should not fail");
...
fn format_startup_profile_tab_append_json(
    append: &TerminalStartupProfileTabAppend,
) -> Result<String> {
    let value = serde_json::json!({
        "startup_config_file": append.path.display().to_string(),
        "status": "ok",
        "profile": append.profile.as_str(),
        "tab": append.tab_number,
        "previous_tab_count": append.previous_tab_count,
        "tab_count": append.tab_count,
        "changed": append.changed,
    ...
    let mut output = serde_json::to_string_pretty(&value)
        .context("failed to serialize terminal startup profile tab append as json")?;
    output.push('\n');
    Ok(output)
}
...
fn format_startup_profile_tab_removal(removal: &TerminalStartupProfileTabRemoval) -> String {
    let mut output = String::new();
    writeln!(
        &mut output,
        "startup_config_file: {}",
...
fn format_startup_profile_tab_removal_json(
    removal: &TerminalStartupProfileTabRemoval,
) -> Result<String> {
    let value = serde_json::json!({
        "startup_config_file": removal.path.display().to_string(),
        "status": "ok",
    ...
    let mut output = serde_json::to_string_pretty(&value)
        .context("failed to serialize terminal startup profile tab removal as json")?;
    output.push('\n');
    Ok(output)
}

fn format_startup_tab_move(move_result: &TerminalStartupTabMove) -> String {
    let mut output = String::new();
    writeln!(
        &mut output,
        "startup_config_file: {}",
        move_result.path.display()
    )
    .expect("writing to string should not fail");
    writeln!(&mut output, "status: ok").expect("writing to string should not fail");
    writeln!(&mut output, "from_tab: {}", move_result.from_tab_number)
        .expect("writing to string should not fail");
    writeln!(&mut output, "to_tab: {}", move_result.to_tab_number)
        .expect("writing to string should not fail");
    writeln!(
        &mut output,
        "previous_tabs: {}",
        move_result.previous_tab_count
    )
    .expect("writing to string should not fail");
    writeln!(&mut output, "tabs: {}", move_result.tab_count)
        .expect("writing to string should not fail");
    writeln!(&mut output, "changed: {}", move_result.changed)
        .expect("writing to string should not fail");
    writeln!(&mut output, "moved_tab_config:").expect("writing to string should not fail");
    if let Some(tab) = &move_result.tab {
        format_startup_profile_tab_description_body(&mut output, "  ", tab);
    } else {
        writeln!(&mut output, "  none").expect("writing to string should not fail");
    }
...
fn format_startup_tab_move_json(move_result: &TerminalStartupTabMove) -> Result<String> {
    let value = serde_json::json!({
        "startup_config_file": move_result.path.display().to_string(),
        "status": "ok",
        "from_tab": move_result.from_tab_number,
        "to_tab": move_result.to_tab_number,
        "previous_tab_count": move_result.previous_tab_count,
        "tab_count": move_result.tab_count,
        "changed": move_result.changed,
        "moved_tab_config": move_result
            .tab
            .as_ref()
            .map(|tab| startup_profile_tab_description_json(move_result.from_tab_number, tab)),
    });
    let mut output = serde_json::to_string_pretty(&value)
        .context("failed to serialize terminal startup tab move as json")?;
    output.push('\n');
    Ok(output)
}
...
mod tests {
  ...
  "tabs": [
    ...
    #[test]
    fn formats_startup_tab_append() {
        let output = format_startup_tab_append(&TerminalStartupTabAppend {
            path: PathBuf::from("terminal.json"),
            tab_number: 2,
    ...
    #[test]
    fn formats_startup_tab_append_json_without_env_values() {
        let output = format_startup_tab_append_json(&TerminalStartupTabAppend {
            path: PathBuf::from("terminal.json"),
            tab_number: 3,
        ...
        .expect("json output should format");
        let json: serde_json::Value =
            serde_json::from_str(&output).expect("startup tab append json should parse");

        assert_eq!(json["startup_config_file"], "terminal.json");
        assert_eq!(json["status"], "ok");
        assert_eq!(json["tab"], 3);
        assert_eq!(json["previous_tab_count"], 2);
        assert_eq!(json["tab_count"], 3);
        assert_eq!(json["changed"], true);
        assert_eq!(json["tab_config"]["tab"], 3);
        assert_eq!(json["tab_config"]["profile"], "work");
        assert_eq!(json["tab_config"]["title"], "Work");
        assert_eq!(json["tab_config"]["env_count"], 1);
        assert_eq!(json["tab_config"]["env_keys"], serde_json::json!(["TOKEN"]));
        assert_eq!(json["tab_config"]["split"], "down");
        assert!(output.ends_with('\n'));
        assert!(!output.contains("secret"));
    }

    #[test]
    fn formats_startup_profile_tab_append() {
        let output = format_startup_profile_tab_append(&TerminalStartupProfileTabAppend {
            path: PathBuf::from("terminal.json"),
            profile: "work".into(),
            tab_number: 2,
            previous_tab_count: 1,
    ...
    #[test]
    fn formats_startup_profile_tab_append_json_without_env_values() {
        let output = format_startup_profile_tab_append_json(&TerminalStartupProfileTabAppend {
            path: PathBuf::from("terminal.json"),
            profile: "work".into(),
            tab_number: 3,
            previous_tab_count: 2,
        ...
        .expect("json output should format");
        let json: serde_json::Value =
            serde_json::from_str(&output).expect("startup profile tab append json should parse");
        ...
        assert_eq!(json["changed"], true);
        assert_eq!(json["tab_config"]["tab"], 3);
        assert_eq!(json["tab_config"]["profile"], "logs");
        assert_eq!(json["tab_config"]["title"], "Logs");
        assert_eq!(json["tab_config"]["env_count"], 1);
        assert_eq!(json["tab_config"]["env_keys"], serde_json::json!(["TOKEN"]));
        assert_eq!(json["tab_config"]["split"], "down");
        assert!(output.ends_with('\n'));
    ...
    #[test]
    fn formats_startup_profile_tab_removal() {
        let output = format_startup_profile_tab_removal(&TerminalStartupProfileTabRemoval {
            path: PathBuf::from("terminal.json"),
            profile: "work".into(),
            tab_number: 2,
            previous_tab_count: 3,
    ...
    #[test]
    fn formats_startup_profile_tab_removal_json_without_env_values() {
        let output = format_startup_profile_tab_removal_json(&TerminalStartupProfileTabRemoval {
            path: PathBuf::from("terminal.json"),
            profile: "work".into(),
            tab_number: 3,
            previous_tab_count: 4,
        ...
        .expect("json output should format");
        let json: serde_json::Value =
            serde_json::from_str(&output).expect("startup profile tab removal json should parse");
        ...
        assert_eq!(json["changed"], true);
        assert_eq!(json["removed_tab_config"]["tab"], 3);
        assert_eq!(json["removed_tab_config"]["profile"], "logs");
        assert_eq!(json["removed_tab_config"]["title"], "Logs");
        assert_eq!(json["removed_tab_config"]["env_count"], 1);
        assert_eq!(
            json["removed_tab_config"]["env_keys"],
            serde_json::json!(["TOKEN"])
        ...
        let json: serde_json::Value = serde_json::from_str(&output)
            .expect("startup profile tab removal noop json should parse");
        assert_eq!(json["removed_tab_config"], serde_json::Value::Null);
    }

    #[test]
    fn formats_startup_tab_move() {
        let output = format_startup_tab_move(&TerminalStartupTabMove {
            path: PathBuf::from("terminal.json"),
            from_tab_number: 1,
            to_tab_number: 3,
            previous_tab_count: 3,
    ...
    #[test]
    fn formats_startup_tab_move_json_without_env_values() {
        let output = format_startup_tab_move_json(&TerminalStartupTabMove {
            path: PathBuf::from("terminal.json"),
            from_tab_number: 3,
            to_tab_number: 1,
            previous_tab_count: 3,
        ...
        .expect("json output should format");
        let json: serde_json::Value =
            serde_json::from_str(&output).expect("startup tab move json should parse");

        assert_eq!(json["startup_config_file"], "terminal.json");
        assert_eq!(json["status"], "ok");
        assert_eq!(json["from_tab"], 3);
        assert_eq!(json["to_tab"], 1);
        assert_eq!(json["previous_tab_count"], 3);
        assert_eq!(json["tab_count"], 3);
        assert_eq!(json["changed"], true);
        assert_eq!(json["moved_tab_config"]["tab"], 3);
        assert_eq!(json["moved_tab_config"]["profile"], "work");
        assert_eq!(json["moved_tab_config"]["title"], "Work");
        assert_eq!(json["moved_tab_config"]["env_count"], 1);
        assert_eq!(
            json["moved_tab_config"]["env_keys"],
            serde_json::json!(["TOKEN"])
        );
        assert_eq!(json["moved_tab_config"]["split"], "down");
        assert!(output.ends_with('\n'));
        assert!(!output.contains("secret"));
        ...
        .expect("json output should format");
        let json: serde_json::Value =
            serde_json::from_str(&output).expect("startup tab move noop json should parse");
        assert_eq!(json["moved_tab_config"], serde_json::Value::Null);
    }
...
"#;
    ...
    #[test]
    fn append_root_startup_tab_initializes_missing_config_file() {
        let root_dir = temp_test_dir();
        let startup_config_file = root_dir.join("config").join("terminal.json");
        let work_dir = root_dir.join("work");
        std_fs::create_dir_all(&work_dir).expect("failed to create work dir");

        let append = append_root_startup_tab(
            &startup_config_file,
            &TerminalStartupTabConfig {
                working_directory: Some(work_dir.clone()),
                command: Some("cmd /C echo tab".into()),
                title: Some("Build".into()),
                env: test_env(&[("TOKEN", "secret"), ("MODE", "test")]),
                split: Some(TerminalStartupSplitDirection::Right),
                ..TerminalStartupTabConfig::default()
            },
        )
        .expect("missing startup config should initialize and append tab");

        assert_eq!(append.path, startup_config_file);
        assert_eq!(append.tab_number, 1);
        assert_eq!(append.previous_tab_count, 0);
        assert_eq!(append.tab_count, 1);
        assert_eq!(append.tab.command.as_deref(), Some("cmd /C echo tab"));
        assert_eq!(append.tab.title.as_deref(), Some("Build"));
        assert_eq!(append.tab.env_keys, vec!["MODE", "TOKEN"]);
        assert_eq!(append.tab.split, Some(TerminalStartupSplitDirection::Right));
        assert!(append.changed);

        let text_output = format_startup_tab_append(&append);
        let json_output =
            format_startup_tab_append_json(&append).expect("json output should format");
        for output in [&text_output, &json_output] {
            assert!(!output.contains("secret"));
        }

        let content =
            std_fs::read_to_string(&append.path).expect("failed to read created startup config");
        assert!(content.contains("// Zed Terminal startup layout."));
        assert!(content.contains(r#""command": "cmd /C echo tab""#));
        assert!(content.contains(r#""title": "Build""#));
        assert!(content.contains(r#""TOKEN": "secret""#));
        assert!(content.contains(r#""MODE": "test""#));
        assert!(content.contains(r#""split": "right""#));
        assert!(content.contains(r#""profiles": {}"#));
        ...
        assert_eq!(
            updated_config.tabs[0].working_directory.as_deref(),
            Some(work_dir.as_path())
        );
        assert_eq!(updated_config.tabs[0].env["TOKEN"], "secret");

        std_fs::remove_dir_all(root_dir).ok();
    }

    #[test]
    fn append_root_startup_tab_preserves_jsonc_comments_and_appends() {
        let root_dir = temp_test_dir();
        let startup_config_file = root_dir.join("terminal.json");
        std_fs::write(
            &startup_config_file,
...
"#,
        ...
        .expect("root startup tab should append");

        assert_eq!(append.tab_number, 2);
        assert_eq!(append.previous_tab_count, 1);
        assert_eq!(append.tab_count, 2);
        assert_eq!(append.tab.title.as_deref(), Some("Shell"));
        assert_eq!(append.tab.split, Some(TerminalStartupSplitDirection::Down));

        let content =
            std_fs::read_to_string(&append.path).expect("failed to read updated startup config");
        assert!(content.contains("// keep leading comment"));
        assert!(content.contains("// keep tabs comment"));
        assert!(content.contains(r#""title": "Logs""#));
        assert!(content.contains(r#""title": "Shell""#));
        assert!(content.contains(r#""split": "down""#));
        assert!(content.contains(r#""display_name": "Work""#));
    ...
    #[test]
    fn append_root_startup_tab_rejects_invalid_profile_reference_without_writing() {
        let root_dir = temp_test_dir();
        let startup_config_file = root_dir.join("terminal.json");
        let original = r#"{
  "tabs": []
...
"#;
        ...
        let error = append_root_startup_tab(
            &startup_config_file,
            &TerminalStartupTabConfig {
                profile: Some("missing".into()),
        ...
        .expect_err("missing profile reference should be rejected");
        let message = format!("{error:#}");

        assert!(message.contains("refusing to append root startup tab"));
        assert!(message.contains("failed to resolve profile for tab 2 for root startup layout"));
        assert!(message.contains("startup profile not found: missing"));
        assert_eq!(
            std_fs::read_to_string(&startup_config_file)
                .expect("failed to read startup config after rejected append"),
            original
        );
    ...
    #[test]
    fn append_root_startup_tab_rejects_env_without_command() {
        let root_dir = temp_test_dir();
        let startup_config_file = root_dir.join("terminal.json");
        let original = r#"{ "tabs": [] }"#;
        std_fs::write(&startup_config_file, original).expect("failed to write startup config");
        ...
        let error = append_root_startup_tab(
            &startup_config_file,
            &TerminalStartupTabConfig {
                env: test_env(&[("TOKEN", "secret")]),
                ..TerminalStartupTabConfig::default()
            },
        )
        .expect_err("environment without command should be rejected");

        assert!(
            format!("{error:#}")
                .contains("environment variables require a command for appended root startup tab")
        );
        assert_eq!(
            std_fs::read_to_string(&startup_config_file)
                .expect("failed to read startup config after rejected append"),
    ...
    #[test]
    fn append_startup_profile_tab_preserves_jsonc_comments_and_appends() {
        let root_dir = temp_test_dir();
        let startup_config_file = root_dir.join("terminal.json");
        std_fs::write(
            &startup_config_file,
...
"#,
        ...
        let append = append_startup_profile_tab(
            &startup_config_file,
            " work ",
            &TerminalStartupTabConfig {
                command: Some("cmd /C echo nested".into()),
        ...
        .expect("startup profile tab should append");

        assert_eq!(append.path, startup_config_file);
        assert_eq!(append.profile, "work");
        assert_eq!(append.tab_number, 2);
        assert_eq!(append.previous_tab_count, 1);
        assert_eq!(append.tab_count, 2);
        assert_eq!(append.tab.command.as_deref(), Some("cmd /C echo nested"));
        assert_eq!(append.tab.title.as_deref(), Some("Nested"));
        assert_eq!(append.tab.env_keys, vec!["MODE", "TOKEN"]);
        assert_eq!(append.tab.split, Some(TerminalStartupSplitDirection::Right));
        assert!(append.changed);

        let text_output = format_startup_profile_tab_append(&append);
        let json_output =
            format_startup_profile_tab_append_json(&append).expect("json output should format");
        for output in [&text_output, &json_output] {
            assert!(!output.contains("secret"));
        ...
        let content =
            std_fs::read_to_string(&append.path).expect("failed to read updated startup config");
        assert!(content.contains("// keep leading comment"));
        assert!(content.contains("// keep profile tabs comment"));
        assert!(content.contains(r#""title": "Root Logs""#));
        assert!(content.contains(r#""title": "Build""#));
        assert!(content.contains(r#""title": "Nested""#));
        assert!(content.contains(r#""command": "cmd /C echo nested""#));
        assert!(content.contains(r#""TOKEN": "secret""#));
        assert!(content.contains(r#""MODE": "test""#));
        assert!(content.contains(r#""split": "right""#));
        ...
        updated_config
            ...
            .expect("updated config should validate");
        assert_eq!(updated_config.tabs.len(), 1);
        assert_eq!(updated_config.tabs[0].title.as_deref(), Some("Root Logs"));
        let work_profile = updated_config
            .profiles
            .get("work")
            .expect("work profile should exist");
        assert_eq!(work_profile.tabs.len(), 2);
        assert_eq!(work_profile.tabs[0].title.as_deref(), Some("Build"));
        assert_eq!(work_profile.tabs[1].title.as_deref(), Some("Nested"));
        assert_eq!(work_profile.tabs[1].env["TOKEN"], "secret");

        std_fs::remove_dir_all(root_dir).ok();
    }

    #[test]
    fn append_startup_profile_tab_inserts_missing_tabs_field() {
        let root_dir = temp_test_dir();
        let startup_config_file = root_dir.join("terminal.json");
        std_fs::write(
            &startup_config_file,
...
"#,
        ...
        let append = append_startup_profile_tab(
            ...
            &TerminalStartupTabConfig {
                title: Some("Shell".into()),
                shell: Some(TerminalStartupShellConfig::Program("pwsh.exe".into())),
                split: Some(TerminalStartupSplitDirection::Left),
                ..TerminalStartupTabConfig::default()
            },
        )
        .expect("startup profile tab should append when tabs field is missing");
        ...
        assert!(content.contains(r#""tabs": ["#));
        assert!(content.contains(r#""title": "Shell""#));
        assert!(content.contains(r#""shell": "pwsh.exe""#));
        assert!(content.contains(r#""split": "left""#));
        ...
        let work_profile = updated_config
            ...
            .get("work")
            .expect("work profile should exist");
        assert_eq!(work_profile.display_name.as_deref(), Some("Work"));
        assert_eq!(work_profile.tabs.len(), 1);
        assert_eq!(work_profile.tabs[0].title.as_deref(), Some("Shell"));

        std_fs::remove_dir_all(root_dir).ok();
    }

    #[test]
    fn append_startup_profile_tab_rejects_missing_profile_without_writing() {
        let root_dir = temp_test_dir();
        let startup_config_file = root_dir.join("terminal.json");
        let original = r#"{
  "profiles": {
...
"#;
        ...
        let error = append_startup_profile_tab(
            &startup_config_file,
            "missing",
            &TerminalStartupTabConfig {
                title: Some("Missing".into()),
        ...
        .expect_err("missing target profile should be rejected");
        let message = format!("{error:#}");
    ...
    #[test]
    fn append_startup_profile_tab_rejects_missing_file() {
        let root_dir = temp_test_dir();
        let startup_config_file = root_dir.join("config").join("terminal.json");
        ...
        .expect_err("missing startup config should be rejected for profile tab append");
    ...
    #[test]
    fn append_startup_profile_tab_rejects_env_without_command() {
        let root_dir = temp_test_dir();
        let startup_config_file = root_dir.join("terminal.json");
        let original = r#"{ "profiles": { "work": {} } }"#;
        std_fs::write(&startup_config_file, original).expect("failed to write startup config");
        ...
        assert!(
            format!("{error:#}").contains(
                "environment variables require a command for appended startup profile tab"
            )
        );
        assert_eq!(
            std_fs::read_to_string(&startup_config_file)
    ...
    #[test]
    fn append_startup_profile_tab_rejects_invalid_profile_reference_without_writing() {
        let root_dir = temp_test_dir();
        let startup_config_file = root_dir.join("terminal.json");
        let original = r#"{
  "profiles": {
...
"#;
        ...
        assert!(message.contains("refusing to append startup profile tab for \"work\""));
        assert!(
            message.contains("failed to resolve profile for tab 2 for startup profile \"work\"")
        );
        assert!(message.contains("startup profile not found: missing"));
        assert_eq!(
            std_fs::read_to_string(&startup_config_file)
...
"#,
    ...
    #[test]
    fn remove_startup_profile_tab_preserves_jsonc_comments_and_removes() {
        let root_dir = temp_test_dir();
        let startup_config_file = root_dir.join("terminal.json");
        std_fs::write(
            &startup_config_file,
  ...
  "profiles": {
    "work": {
      ...
      "tabs": [
        { "title": "Logs" },
        {
          // keep removed nested tab comment
          "command": "cmd /C echo build",
          "title": "Build",
          "env": {
            "TOKEN": "secret",
...
"#,
        ...
        let removal = remove_startup_profile_tab(&startup_config_file, " work ", 2)
            .expect("startup profile tab should be removed");
        ...
        let text_output = format_startup_profile_tab_removal(&removal);
        let json_output =
            format_startup_profile_tab_removal_json(&removal).expect("json output should format");
        for output in [&text_output, &json_output] {
            assert!(!output.contains("secret"));
            assert!(output.contains("TOKEN"));
        }
        ...
        assert!(content.contains(r#""title": "Logs""#));
        assert!(content.contains(r#""title": "Shell""#));
        assert!(content.contains(r#""title": "Other""#));
        assert!(!content.contains(r#""title": "Build""#));
        assert!(!content.contains("secret"));
        ...
        let work_profile = updated_config
            ...
            .expect("work profile should exist");
        assert_eq!(work_profile.tabs.len(), 2);
        assert_eq!(work_profile.tabs[0].title.as_deref(), Some("Logs"));
        assert_eq!(work_profile.tabs[1].title.as_deref(), Some("Shell"));
        let logs_profile = updated_config
            .profiles
            .get("logs")
            .expect("logs profile should exist");
        assert_eq!(logs_profile.tabs.len(), 1);
        assert_eq!(logs_profile.tabs[0].title.as_deref(), Some("Other"));

        std_fs::remove_dir_all(root_dir).ok();
    }

    #[test]
    fn remove_startup_profile_tab_reports_unchanged_when_out_of_range() {
        let root_dir = temp_test_dir();
        let startup_config_file = root_dir.join("terminal.json");
        let original = r#"{
  "profiles": {
...
"#;
        ...
        let removal = remove_startup_profile_tab(&startup_config_file, "work", 2)
            .expect("out-of-range startup profile tab removal should be a no-op");
    ...
    #[test]
    fn remove_startup_profile_tab_reports_unchanged_when_file_is_missing() {
        let root_dir = temp_test_dir();
        let startup_config_file = root_dir.join("config").join("terminal.json");

        let removal = remove_startup_profile_tab(&startup_config_file, " work ", 1)
            .expect("missing startup config profile tab removal should be a no-op");
    ...
    #[test]
    fn remove_startup_profile_tab_reports_unchanged_when_profile_is_missing() {
        let root_dir = temp_test_dir();
        let startup_config_file = root_dir.join("terminal.json");
        let original = r#"{
  "profiles": {
...
"#;
        ...
        let removal = remove_startup_profile_tab(&startup_config_file, "missing", 1)
            .expect("missing startup profile tab removal should be a no-op");

        assert_eq!(removal.path, startup_config_file);
        assert_eq!(removal.profile, "missing");
        assert_eq!(removal.tab_number, 1);
        assert_eq!(removal.previous_tab_count, 0);
        assert_eq!(removal.tab_count, 0);
        assert!(removal.tab.is_none());
    ...
    #[test]
    fn remove_startup_profile_tab_rejects_zero() {
        let root_dir = temp_test_dir();
        let startup_config_file = root_dir.join("terminal.json");

        let error = remove_startup_profile_tab(&startup_config_file, "work", 0)
            .expect_err("zero profile startup tab number should be rejected");
        assert!(format!("{error:#}").contains("uses 1-based profile tabs[] numbering"));
        assert!(
            !startup_config_file.exists(),
            "rejected removal should not create terminal.json"
        );
    ...
    #[test]
    fn remove_startup_profile_tab_repairs_invalid_removed_profile_reference() {
        let root_dir = temp_test_dir();
        let startup_config_file = root_dir.join("terminal.json");
        std_fs::write(
            &startup_config_file,
...
"#,
        ...
        let removal = remove_startup_profile_tab(&startup_config_file, "work", 1)
            .expect("removing the invalid startup profile tab should repair the config");
    ...
    #[test]
    fn move_root_startup_tab_preserves_jsonc_surrounding_fields_and_moves() {
        let root_dir = temp_test_dir();
        let startup_config_file = root_dir.join("terminal.json");
        std_fs::write(
            &startup_config_file,
            r#"// keep leading comment
{
  ...
  "tabs": [
    { "title": "Logs" },
    {
      // internal tab comments may be normalized when reordering
      "command": "cmd /C echo build",
      "title": "Build",
      "env": {
        "TOKEN": "secret",
...
"#,
        ...
        let move_result = move_root_startup_tab(&startup_config_file, 1, 3)
            .expect("root startup tab should move");

        assert_eq!(move_result.path, startup_config_file);
        assert_eq!(move_result.from_tab_number, 1);
        assert_eq!(move_result.to_tab_number, 3);
        assert_eq!(move_result.previous_tab_count, 3);
        assert_eq!(move_result.tab_count, 3);
        assert!(move_result.changed);
        let moved_tab = move_result
            .tab
            .as_ref()
            .expect("moved tab should be reported");
        assert_eq!(moved_tab.title.as_deref(), Some("Logs"));

        let text_output = format_startup_tab_move(&move_result);
        let json_output =
            format_startup_tab_move_json(&move_result).expect("json output should format");
        for output in [&text_output, &json_output] {
            assert!(!output.contains("secret"));
            assert!(output.contains("Logs"));
        }

        let content = std_fs::read_to_string(&move_result.path)
            .expect("failed to read updated startup config");
        assert!(content.contains("// keep leading comment"));
        assert!(content.contains("// keep tabs comment"));
        ...
        updated_config
            .validate()
            .expect("updated config should validate");
        assert_eq!(updated_config.tabs.len(), 3);
        assert_eq!(updated_config.tabs[0].title.as_deref(), Some("Build"));
        assert_eq!(updated_config.tabs[1].title.as_deref(), Some("Shell"));
        assert_eq!(updated_config.tabs[2].title.as_deref(), Some("Logs"));
        assert_eq!(updated_config.tabs[0].env["TOKEN"], "secret");
    ...
    #[test]
    fn move_root_startup_tab_reports_unchanged_when_from_out_of_range() {
        let root_dir = temp_test_dir();
        let startup_config_file = root_dir.join("terminal.json");
        let original = r#"{
  "tabs": [
...
"#;
        ...
        let move_result = move_root_startup_tab(&startup_config_file, 3, 1)
            .expect("out-of-range source startup tab move should be a no-op");

        assert_eq!(move_result.path, startup_config_file);
        assert_eq!(move_result.from_tab_number, 3);
        assert_eq!(move_result.to_tab_number, 1);
        assert_eq!(move_result.previous_tab_count, 2);
        assert_eq!(move_result.tab_count, 2);
        assert!(move_result.tab.is_none());
        assert!(!move_result.changed);
        assert_eq!(
            std_fs::read_to_string(&startup_config_file)
                .expect("failed to read startup config after no-op move"),
            original
        );
    ...
    #[test]
    fn move_root_startup_tab_reports_unchanged_when_to_out_of_range() {
        let root_dir = temp_test_dir();
        let startup_config_file = root_dir.join("terminal.json");
        let original = r#"{
  "tabs": [
...
"#;
        ...
        let move_result = move_root_startup_tab(&startup_config_file, 1, 3)
            .expect("out-of-range destination startup tab move should be a no-op");
        ...
        let moved_tab = move_result
            .tab
            .as_ref()
            .expect("existing source tab should be reported");
        assert_eq!(moved_tab.title.as_deref(), Some("Logs"));
        assert!(!move_result.changed);
        assert_eq!(
            std_fs::read_to_string(&startup_config_file)
    ...
    #[test]
    fn move_root_startup_tab_reports_unchanged_when_same_tab() {
        let root_dir = temp_test_dir();
        let startup_config_file = root_dir.join("terminal.json");
        let original = r#"{
  "tabs": [
...
"#;
        ...
        let move_result =
            move_root_startup_tab(&startup_config_file, 2, 2).expect("same-tab move should no-op");

        assert_eq!(move_result.path, startup_config_file);
        assert_eq!(move_result.from_tab_number, 2);
        assert_eq!(move_result.to_tab_number, 2);
        assert_eq!(move_result.previous_tab_count, 2);
        assert_eq!(move_result.tab_count, 2);
        let moved_tab = move_result
            .tab
            .as_ref()
            .expect("same source tab should be reported");
        assert_eq!(moved_tab.title.as_deref(), Some("Shell"));
        assert!(!move_result.changed);
        assert_eq!(
            std_fs::read_to_string(&startup_config_file)
                .expect("failed to read startup config after no-op move"),
    ...
    #[test]
    fn move_root_startup_tab_reports_unchanged_when_file_is_missing() {
        let root_dir = temp_test_dir();
        let startup_config_file = root_dir.join("config").join("terminal.json");

        let move_result = move_root_startup_tab(&startup_config_file, 1, 2)
            .expect("missing startup config move should be a no-op");

        assert_eq!(move_result.path, startup_config_file);
        assert_eq!(move_result.from_tab_number, 1);
        assert_eq!(move_result.to_tab_number, 2);
        assert_eq!(move_result.previous_tab_count, 0);
        assert_eq!(move_result.tab_count, 0);
        assert!(move_result.tab.is_none());
        assert!(!move_result.changed);
        assert!(
            !move_result.path.exists(),
            "moving from a missing startup config should not create terminal.json"
        );
    ...
    #[test]
    fn move_root_startup_tab_rejects_zero_from_or_to() {
        let root_dir = temp_test_dir();
        let startup_config_file = root_dir.join("terminal.json");

        let error = move_root_startup_tab(&startup_config_file, 0, 1)
            .expect_err("zero source startup tab number should be rejected");
        assert!(format!("{error:#}").contains("uses 1-based root tabs[] numbering"));
        let error = move_root_startup_tab(&startup_config_file, 1, 0)
            .expect_err("zero destination startup tab number should be rejected");
        assert!(format!("{error:#}").contains("uses 1-based root tabs[] numbering"));
        assert!(
            !startup_config_file.exists(),
            "rejected move should not create terminal.json"
        );
    ...
    #[test]
    fn move_root_startup_tab_rejects_invalid_config_without_writing() {
        let root_dir = temp_test_dir();
        let startup_config_file = root_dir.join("terminal.json");
        let original = r#"{
  "tabs": [
...
"#;
        ...
        let error = move_root_startup_tab(&startup_config_file, 2, 1)
            .expect_err("moving should not repair unrelated invalid startup config entries");
        let message = format!("{error:#}");

        assert!(message.contains("refusing to move root startup tab 2 to 1"));
        assert!(message.contains("failed to resolve profile"));
        assert!(message.contains("startup profile not found: missing"));
        assert_eq!(
            std_fs::read_to_string(&startup_config_file)
                .expect("failed to read startup config after rejected move"),
            original
        );
...
"#;
    ...
    #[test]
    fn add_startup_tab_format_json_is_carried_through_cli_resolution() {
        let work_dir = temp_test_dir();
        let cli = Cli::try_parse_from([
            "zed-terminal",
            "--add-startup-tab",
            "--startup-tab-working-directory",
            work_dir.to_str().unwrap(),
            "--startup-tab-command",
            "cmd /C echo tab",
            "--startup-tab-title",
        ...
        .expect("failed to parse add startup tab json args");
        let command =
            TerminalCliCommand::from_cli_and_startup_config(cli, TerminalStartupConfig::default())
                .expect("add startup tab json mode should resolve");

        let TerminalCliCommand::AddStartupTab { tab, format, .. } = command else {
            panic!("expected add startup tab mode");
        };
        assert_eq!(tab.working_directory, Some(work_dir.clone()));
        assert_eq!(tab.command.as_deref(), Some("cmd /C echo tab"));
        assert_eq!(tab.title.as_deref(), Some("Build"));
        assert_eq!(tab.env, test_env(&[("MODE", "dev "), ("TOKEN", "secret")]));
        assert_eq!(tab.split, Some(TerminalStartupSplitDirection::Right));
        assert_eq!(format, TerminalStartupTabAppendOutputFormat::Json);
        ...
        let cli = Cli::try_parse_from([
            ...
            "--startup-tab-shell",
            "pwsh.exe",
            "--startup-tab-shell-arg",
            "-NoLogo",
            "--startup-tab-shell-arg",
            "-NoProfile",
        ])
        .expect("failed to parse add startup tab shell args");
        let command =
            TerminalCliCommand::from_cli_and_startup_config(cli, TerminalStartupConfig::default())
                .expect("add startup tab shell mode should resolve");

        let TerminalCliCommand::AddStartupTab { tab, format, .. } = command else {
            panic!("expected add startup tab shell mode");
        };
        assert_eq!(
            tab.shell,
            Some(TerminalStartupShellConfig::WithArguments(
        ...
        .expect("failed to parse add startup tab profile args");
        let command =
            TerminalCliCommand::from_cli_and_startup_config(cli, TerminalStartupConfig::default())
                .expect("add startup tab profile mode should resolve");

        let TerminalCliCommand::AddStartupTab { tab, format, .. } = command else {
            panic!("expected add startup tab profile mode");
        };
        assert_eq!(tab.profile.as_deref(), Some("work"));
        assert_eq!(tab.title.as_deref(), Some("Work"));
        assert_eq!(tab.split, Some(TerminalStartupSplitDirection::Down));
        assert_eq!(format, TerminalStartupTabAppendOutputFormat::Text);
    ...
    #[test]
    fn add_profile_startup_tab_format_json_is_carried_through_cli_resolution() {
        let work_dir = temp_test_dir();
        let cli = Cli::try_parse_from([
            "zed-terminal",
            "--add-profile-startup-tab",
            " work ",
            "--startup-tab-working-directory",
            work_dir.to_str().unwrap(),
            "--startup-tab-command",
            ...
            "--startup-tab-split",
            "right",
            "--add-profile-startup-tab-format",
            "json",
        ])
        .expect("failed to parse add profile startup tab json args");
        let command =
            TerminalCliCommand::from_cli_and_startup_config(cli, TerminalStartupConfig::default())
                .expect("add profile startup tab json mode should resolve");

        let TerminalCliCommand::AddProfileStartupTab {
            profile,
            tab,
            format,
            ..
            ...
            panic!("expected add profile startup tab mode");
        };
        assert_eq!(profile, "work");
        assert_eq!(tab.working_directory, Some(work_dir.clone()));
        assert_eq!(tab.command.as_deref(), Some("cmd /C echo tab"));
        ...
        assert_eq!(tab.env, test_env(&[("MODE", "dev "), ("TOKEN", "secret")]));
        assert_eq!(tab.split, Some(TerminalStartupSplitDirection::Right));
        assert_eq!(format, TerminalStartupProfileTabAppendOutputFormat::Json);
        ...
        .expect("failed to parse add profile startup tab shell args");
        let command =
            TerminalCliCommand::from_cli_and_startup_config(cli, TerminalStartupConfig::default())
                .expect("add profile startup tab shell mode should resolve");
        ...
        let TerminalCliCommand::AddProfileStartupTab {
            ...
            panic!("expected add profile startup tab shell mode");
        };
        assert_eq!(profile, "work");
        assert_eq!(
            tab.shell,
        ...
        assert_eq!(format, TerminalStartupProfileTabAppendOutputFormat::Text);
        ...
        .expect("failed to parse add profile startup tab profile args");
        let command =
            TerminalCliCommand::from_cli_and_startup_config(cli, TerminalStartupConfig::default())
                .expect("add profile startup tab profile mode should resolve");
        ...
        let TerminalCliCommand::AddProfileStartupTab {
            ...
            panic!("expected add profile startup tab profile mode");
        };
        assert_eq!(profile, "work");
        assert_eq!(tab.profile.as_deref(), Some("logs"));
    ...
    #[test]
    fn remove_profile_startup_tab_format_json_is_carried_through_cli_resolution() {
        let cli = Cli::try_parse_from([
            "zed-terminal",
            "--remove-profile-startup-tab",
            " work ",
            "--profile-startup-tab",
            "2",
            "--remove-profile-startup-tab-format",
            "json",
        ])
        .expect("failed to parse remove profile startup tab json args");
        let command =
            TerminalCliCommand::from_cli_and_startup_config(cli, TerminalStartupConfig::default())
                .expect("remove profile startup tab json mode should resolve");

        let TerminalCliCommand::RemoveProfileStartupTab {
            profile,
            tab_number,
            format,
            ..
            ...
            panic!("expected remove profile startup tab mode");
        };
        assert_eq!(profile, "work");
        assert_eq!(tab_number, 2);
        assert_eq!(format, TerminalStartupProfileTabRemovalOutputFormat::Json);
        ...
        .expect("failed to parse remove profile startup tab args");
        let command =
            TerminalCliCommand::from_cli_and_startup_config(cli, TerminalStartupConfig::default())
                .expect("remove profile startup tab mode should resolve");
        ...
        assert_eq!(profile, "work");
        assert_eq!(tab_number, 1);
        assert_eq!(format, TerminalStartupProfileTabRemovalOutputFormat::Text);
    }

    #[test]
    fn move_startup_tab_format_json_is_carried_through_cli_resolution() {
        let cli = Cli::try_parse_from([
            "zed-terminal",
            "--move-startup-tab",
            "2",
            "--to-startup-tab",
            "4",
            "--move-startup-tab-format",
            "json",
        ])
        .expect("failed to parse move startup tab json args");
        let command =
            TerminalCliCommand::from_cli_and_startup_config(cli, TerminalStartupConfig::default())
                .expect("move startup tab json mode should resolve");

        let TerminalCliCommand::MoveStartupTab {
            from_tab_number,
            to_tab_number,
            format,
            ..
            ...
            panic!("expected move startup tab mode");
        };
        assert_eq!(from_tab_number, 2);
        assert_eq!(to_tab_number, 4);
        assert_eq!(format, TerminalStartupTabMoveOutputFormat::Json);
        ...
        .expect("failed to parse move startup tab args");
        let command =
            TerminalCliCommand::from_cli_and_startup_config(cli, TerminalStartupConfig::default())
                .expect("move startup tab mode should resolve");
        ...
        assert_eq!(from_tab_number, 1);
        assert_eq!(to_tab_number, 2);
        assert_eq!(format, TerminalStartupTabMoveOutputFormat::Text);
    }
    ...
    #[test]
    fn add_startup_tab_mode_does_not_load_startup_config_during_cli_resolution() {
        let data_dir = temp_test_dir();
        let config_dir = data_dir.join("config");
        std_fs::create_dir_all(&config_dir).expect("failed to create config dir");
        std_fs::write(
        ...
        .expect("failed to parse cli args");
        let command = TerminalCliCommand::from_cli_and_config_file(cli)
            .expect("add-startup-tab mode should not load terminal.json during cli resolution");

        let TerminalCliCommand::AddStartupTab {
            path_options,
            tab,
            format,
        } = command
    ...
    #[test]
    fn add_profile_startup_tab_mode_does_not_load_startup_config_during_cli_resolution() {
        let data_dir = temp_test_dir();
        let config_dir = data_dir.join("config");
        std_fs::create_dir_all(&config_dir).expect("failed to create config dir");
        std_fs::write(
        ...
        .expect("failed to parse cli args");
        let command = TerminalCliCommand::from_cli_and_config_file(cli).expect(
            "add-profile-startup-tab mode should not load terminal.json during cli resolution",
        );
    ...
    #[test]
    fn remove_profile_startup_tab_mode_does_not_load_startup_config_during_cli_resolution() {
        let data_dir = temp_test_dir();
        let config_dir = data_dir.join("config");
        std_fs::create_dir_all(&config_dir).expect("failed to create config dir");
        std_fs::write(
        ...
        .expect("failed to parse cli args");
        let command = TerminalCliCommand::from_cli_and_config_file(cli).expect(
            "remove-profile-startup-tab mode should not load terminal.json during cli resolution",
        );
    ...
    #[test]
    fn move_startup_tab_mode_does_not_load_startup_config_during_cli_resolution() {
        let data_dir = temp_test_dir();
        let config_dir = data_dir.join("config");
        std_fs::create_dir_all(&config_dir).expect("failed to create config dir");
        std_fs::write(
        ...
        .expect("failed to parse cli args");
        let command = TerminalCliCommand::from_cli_and_config_file(cli)
            .expect("move-startup-tab mode should not load terminal.json during cli resolution");
    ...
    #[test]
    fn add_startup_tab_rejects_startup_only_arguments() {
        let error =
            Cli::try_parse_from(["zed-terminal", "--add-startup-tab", "--profile", "admin"])
                .expect_err("profile selection should conflict with startup tab append");
        assert!(error.to_string().contains("cannot be used with"));
        ...
        .expect_err("startup directory should conflict with startup tab append");
        assert!(error.to_string().contains("cannot be used with"));
        ...
        .expect_err("startup tab command should conflict with startup tab append");
        assert!(error.to_string().contains("cannot be used with"));

        let error = Cli::try_parse_from(["zed-terminal", "--add-startup-tab", "--paths"])
            .expect_err("path inspection should conflict with startup tab append");
        assert!(error.to_string().contains("cannot be used with"));

        let error = Cli::try_parse_from(["zed-terminal", "--add-startup-tab-format", "json"])
        ...
        .expect_err("startup tab env should require a command-backed tab");
        assert!(error.to_string().contains("required"));
        ...
        .expect_err("profile startup tab should conflict with command fields");
        assert!(error.to_string().contains("cannot be used with"));
        ...
        .expect_err("command-backed startup tab should conflict with shell fields");
        assert!(error.to_string().contains("cannot be used with"));
        ...
        .expect_err("startup tab shell args should require a shell");
        assert!(error.to_string().contains("required"));
        ...
        .expect("blank startup tab command should parse as raw cli value");
        let error =
            TerminalCliCommand::from_cli_and_startup_config(cli, TerminalStartupConfig::default())
                .expect_err("blank startup tab command should be rejected");
        assert!(format!("{error:#}").contains("--startup-tab-command is empty"));
        ...
        .expect("unclosed startup tab command should parse as raw cli value");
        let error =
            TerminalCliCommand::from_cli_and_startup_config(cli, TerminalStartupConfig::default())
                .expect_err("unclosed startup tab command quote should be rejected");
        assert!(format!("{error:#}").contains("failed to parse --startup-tab-command"));
        ...
        .expect("blank startup tab profile should parse as raw cli value");
        let error =
            TerminalCliCommand::from_cli_and_startup_config(cli, TerminalStartupConfig::default())
                .expect_err("blank startup tab profile should be rejected");
        assert!(format!("{error:#}").contains("startup profile name is empty"));
        ...
        .expect("startup tab env assignment without separator should parse as raw cli value");
        let error =
            TerminalCliCommand::from_cli_and_startup_config(cli, TerminalStartupConfig::default())
                .expect_err("startup tab env assignment without separator should be rejected");
        assert!(format!("{error:#}").contains("--startup-tab-env requires KEY=VALUE"));
        ...
        .expect("startup tab env assignment with blank key should parse as raw cli value");
        let error =
            TerminalCliCommand::from_cli_and_startup_config(cli, TerminalStartupConfig::default())
                .expect_err("blank startup tab env key should be rejected");
        assert!(format!("{error:#}").contains("startup tab environment variable key is empty"));
        ...
        .expect_err("root environment updates should conflict with startup tab append");
        assert!(error.to_string().contains("cannot be used with"));
    ...
    #[test]
    fn add_profile_startup_tab_rejects_startup_only_arguments() {
        let error = Cli::try_parse_from([
            "zed-terminal",
            "--add-profile-startup-tab",
            "work",
        ...
        .expect_err("profile selection should conflict with startup profile tab append");
        assert!(error.to_string().contains("cannot be used with"));
        ...
        .expect_err("startup directory should conflict with startup profile tab append");
        assert!(error.to_string().contains("cannot be used with"));
        ...
        .expect_err("startup tab command should conflict with startup profile tab append");
        assert!(error.to_string().contains("cannot be used with"));
        ...
        .expect_err("path inspection should conflict with startup profile tab append");
        assert!(error.to_string().contains("cannot be used with"));

        let error =
            Cli::try_parse_from(["zed-terminal", "--add-profile-startup-tab-format", "json"])
                .expect_err(
                    "add profile startup tab format should require startup profile tab append mode",
                );
        assert!(error.to_string().contains("required"));
        ...
        .expect_err("root startup tab append format should conflict with profile tab append");
        assert!(error.to_string().contains("cannot be used with"));
        ...
        .expect_err("startup tab removal format should conflict with profile tab append");
        assert!(error.to_string().contains("cannot be used with"));
        ...
        .expect_err("startup tab move format should conflict with profile tab append");
        assert!(error.to_string().contains("cannot be used with"));

        let error = Cli::try_parse_from(["zed-terminal", "--startup-tab-title", "Logs"])
            .expect_err("startup tab title should require a startup tab append mode");
        assert!(error.to_string().contains("required"));
        ...
        .expect("blank target profile should parse as raw cli value");
        let error =
            TerminalCliCommand::from_cli_and_startup_config(cli, TerminalStartupConfig::default())
                .expect_err("blank target profile should be rejected");
        assert!(format!("{error:#}").contains("startup profile name is empty"));
        ...
        .expect_err("root environment updates should conflict with startup profile tab append");
        assert!(error.to_string().contains("cannot be used with"));
    ...
    #[test]
    fn remove_profile_startup_tab_rejects_startup_only_arguments() {
        let error = Cli::try_parse_from([
            "zed-terminal",
            "--remove-profile-startup-tab",
            "work",
        ...
        .expect_err("profile selection should conflict with startup profile tab removal");
        assert!(error.to_string().contains("cannot be used with"));
        ...
        .expect_err("startup directory should conflict with startup profile tab removal");
        assert!(error.to_string().contains("cannot be used with"));
        ...
        .expect_err("startup tab command should conflict with startup profile tab removal");
        assert!(error.to_string().contains("cannot be used with"));
        ...
        .expect_err("path inspection should conflict with startup profile tab removal");
        assert!(error.to_string().contains("cannot be used with"));

        let error = Cli::try_parse_from(["zed-terminal", "--remove-profile-startup-tab", "work"])
            .expect_err("startup profile tab removal should require a tab number");
        assert!(error.to_string().contains("required"));

        let error = Cli::try_parse_from(["zed-terminal", "--profile-startup-tab", "1"])
            .expect_err("profile startup tab number should require profile tab removal mode");
        assert!(error.to_string().contains("required"));
        ...
        .expect_err("remove profile startup tab format should require profile tab removal mode");
        assert!(error.to_string().contains("required"));
        ...
        .expect_err("startup tab append format should conflict with profile tab removal");
        assert!(error.to_string().contains("cannot be used with"));
        ...
        .expect_err("root startup tab removal format should conflict with profile tab removal");
        assert!(error.to_string().contains("cannot be used with"));
        ...
        .expect_err("startup tab move format should conflict with profile tab removal");
        assert!(error.to_string().contains("cannot be used with"));
        ...
        .expect("zero profile tab number should parse as a usize");
        let error =
            TerminalCliCommand::from_cli_and_startup_config(cli, TerminalStartupConfig::default())
                .expect_err("zero profile tab number should fail command resolution");
        assert!(format!("{error:#}").contains("uses 1-based profile tabs[] numbering"));
    ...
    #[test]
    fn move_startup_tab_rejects_startup_only_arguments() {
        let error = Cli::try_parse_from([
            "zed-terminal",
            "--move-startup-tab",
            "1",
        ...
        .expect_err("profile selection should conflict with startup tab move");
        assert!(error.to_string().contains("cannot be used with"));
        ...
        .expect_err("startup directory should conflict with startup tab move");
        assert!(error.to_string().contains("cannot be used with"));
        ...
        .expect_err("startup tab command should conflict with startup tab move");
        assert!(error.to_string().contains("cannot be used with"));
        ...
        .expect_err("path inspection should conflict with startup tab move");
        assert!(error.to_string().contains("cannot be used with"));

        let error = Cli::try_parse_from(["zed-terminal", "--move-startup-tab", "1"])
            .expect_err("move startup tab should require a destination");
        assert!(error.to_string().contains("required"));

        let error = Cli::try_parse_from(["zed-terminal", "--move-startup-tab-format", "json"])
            .expect_err("move startup tab format should require startup tab move mode");
        assert!(error.to_string().contains("required"));
        ...
        .expect_err("startup tab append format should conflict with startup tab move");
        assert!(error.to_string().contains("cannot be used with"));
        ...
        .expect_err("startup tab removal format should conflict with startup tab move");
        assert!(error.to_string().contains("cannot be used with"));
        ...
        .expect_err("startup tab move format should conflict with startup tab removal");
        assert!(error.to_string().contains("cannot be used with"));
        ...
        .expect("zero source tab number should parse as a usize");
        let error =
            TerminalCliCommand::from_cli_and_startup_config(cli, TerminalStartupConfig::default())
                .expect_err("zero source tab number should fail command resolution");
        assert!(format!("{error:#}").contains("uses 1-based root tabs[] numbering"));
        ...
        .expect("zero destination tab number should parse as a usize");
        let error =
            TerminalCliCommand::from_cli_and_startup_config(cli, TerminalStartupConfig::default())
                .expect_err("zero destination tab number should fail command resolution");
        assert!(format!("{error:#}").contains("uses 1-based root tabs[] numbering"));
    ...
    fn non_launch_modes_reject_startup_title_arguments() {
        for mode in [
            ...
            let mode_args = match mode {
                ...
                "--remove-profile-startup-tab" => {
                    vec!["zed-terminal", mode, "work", "--profile-startup-tab", "1"]
                }
                "--move-startup-tab" => {
                    vec!["zed-terminal", mode, "1", "--to-startup-tab", "2"]
                }
